...
function loadLevel1() {
    return new Level(
        ...
        [
            ...
            new BackgroundObject('/img/set1/5_background/layers/3_third_layer/2.png', 720*5, 0, 720),
            new BackgroundObject('/img/set1/5_background/layers/3_third_layer/1.png', 720*6, 0, 720),
            ...
            new BackgroundObject('/img/set1/5_background/layers/2_second_layer/2.png', 720*5, 0, 720),
            new BackgroundObject('/img/set1/5_background/layers/2_second_layer/1.png', 720*6, 0, 720),
            ...
            new BackgroundObject('/img/set1/5_background/layers/1_first_layer/2.png', 720*5, 0, 720),
            new BackgroundObject('/img/set1/5_background/layers/1_first_layer/1.png', 720*6, 0, 720),
